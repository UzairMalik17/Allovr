...
function Hero() {
  return (
    <ComponentWrapper
      style={`font-workSans bg-[url('./images/bottomGr.png')] md:bg-Gradient bg-center bg-no-repeat bg-cover relative`}>
      <div className="w-full h-[1000px] md:h-screen text-[56px] md:text-[94px] flex flex-col gap-4 md:flex-row font-bold leading-[61px] md:leading-[105.6px] items-center font-workSans justify-between">
        ...
        <div className="w-full md:w-1/2 h-[600px] md:h-screen bg-Hero absolute right-0 bottom-0 bg-no-repeat bg-cover bg-center"></div>
      </div>
    </ComponentWrapper>
  );
}
